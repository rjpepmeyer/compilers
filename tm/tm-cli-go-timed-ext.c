...
/*
   Modification History
      ...
      December 2013   Eugene Wallingford
         ...
         * Reports rudimentary execution time of the TM program,
         in terms of clock ticks consumed.
...
#include <string.h>
#include <ctype.h>
#include <time.h>               // added to support execution timing
...
/******* const *******/
#define   IADDR_SIZE  1048576 /* increase for large programs */
#define   DADDR_SIZE  1048576 /* increase for large programs */
#define   NO_REGS 8
#define   PC_REG  7
...
int main( int argc, char * argv[] )
{
  ...
  // report number of clock ticks as execution time
  // ----------------------------------------------
  clock_t time_start;
  clock_t time_end;
  ...
  time_end = clock();
  printf("Number of instructions executed = %d\n", stepcnt);
  printf("Execution took %ld clicks.\n",
        (long)time_end - (long)time_start);
